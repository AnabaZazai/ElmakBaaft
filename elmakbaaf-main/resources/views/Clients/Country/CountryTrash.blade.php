                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                                <tr>
                                    ...
                                    <td class="p-3 flex">                                      
                                        <a href="{{url('/country/reastore',$country->id)}}" class="text-blue-400 hover:text-gray-100 ml-5   py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded2">
                                           Restore
                                        </a>
                                        <a  href="javascript:void(0)" recordid="{{$country->id}}" class="ConfirmDelete  hover:text-gray-100 ml-5 text-red-400  py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded">
