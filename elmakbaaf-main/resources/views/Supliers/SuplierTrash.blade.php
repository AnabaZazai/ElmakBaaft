                              ...
                              <table   class="min-w-full"> 
                                <thead>                       
                                  <tr >
                                        ...
                                        <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider pl-24">Actions</th>
                                 </tr>
                                </thead>
                                <tbody>
                                 <tr >
                                    @foreach ($supliers as $suplier)   
                                       ...
                                       <td class="px-2 flex py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">                                      
                                        <a href="{{url('/suplier/reastore',$suplier->id)}}" class="text-blue-400 hover:text-gray-100 ml-5   py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded2">
                                            Restore
                                        </a>
                                        <a  href="javascript:void(0)"  recordid="{{$suplier->id}}" class="ConfirmDelete text-red-400 hover:text-gray-100 ml-5   py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded2">
                                            Delete
                                        </a>
                                    </td>
