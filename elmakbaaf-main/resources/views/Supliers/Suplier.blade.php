...
<!----Form of Add Suplier  ---->
        ...
        <div class="border-collapse w-full flex flex-col pt-4 bg-gray-100">
            ...
            <form class="p-10 ml-5 mr-5 bg-white rounded shadow-xl" method="Post" id="SupplierForm">
              @csrf
                ...
                <div class="inline-block mt-2 w-1/2 pr-1">
                  ...
                  <input   class="w-full px-2 py-2 text-gray-700 " id="" name="first_name" type="text"  placeholder="First Name" data-parsley-pattern="[a-zA-Z ]+$" data-parsley-trigger="keyup">
                    @error('first_name')
                ...
                <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                  ...
                  <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="last_name" type="text"  placeholder="Last Name" data-parsley-pattern="[a-zA-Z ]+$" data-parsley-trigger="keyup">
                    @error('last_name')
                    <div class="text-sm text-red-600">{{ $message }}</div>
                    @enderror
                </div>
              ...
              <div class="inline-block mt-2 w-1/2 pr-1">
                ...
                <input   class="w-full px-2 py-2 text-gray-700 " id="" name="email" type="email"   placeholder=""  data-parsley-type="email" data-parsley-trigger="keyup">
                    @error('last_name')
                    <div class="text-sm text-red-600">{{ $message }}</div>
                    @enderror
            </div>
            ...
            <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                ...
                <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="contact_num" type="tel"  placeholder="" data-parsley-pattern="[0-9]+$" data-parsley-length="[10-13]+$"  data-parsley-trigger="keyup">
                    @error('contact_num')
                    <div class="text-sm text-red-600">{{ $message }}</div>
                    @enderror
            </div>
                ...
                <div class="inline-block mt-2 w-1/2 pr-1">
                  ...
                  <input   class="w-full px-2 py-2 text-gray-700 " id="" name="company_name" type="text"  placeholder="" >
                    @error('company_name')
                    <div class="text-sm text-red-600">{{ $message }}</div>
                   @enderror
                </div>
              ...
              <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                  ...
                  <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="joining_date" type="date"  placeholder="" >
                  @error('joining_date')
                  <div class="text-sm text-red-600">{{ $message }}</div>
                  @enderror
            </div>
            ...
            <select class="w-full px-2 py-2 text-gray-700 "  id="catagory" name="catagory_id">
              ...
              @endforeach
                ...
                <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                    ...
                    <input  class="w-full px-2 py-2 text-gray-700 " id=""  name="zip" type="text"  placeholder="Zip" >
                        @error('zip')
                        <div class="text-sm text-red-600">{{ $message }}</div>
                        @enderror
                </div>
