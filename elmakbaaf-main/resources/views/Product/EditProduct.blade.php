        ...
        <form class="p-10 bg-white rounded shadow-xl" method="Post" enctype="multipart/form-data" >
          ...
          @method('PUT')
            ...
            <div class="inline-block mt-2 w-1/2 pr-1">
                ...
                <input   class="w-full px-2 py-2 text-gray-700 " id="" name="design" type="text"  placeholder="" value="{{$product->design}}" >
            </div>
            <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                <label class=" block text-sm text-gray-600" for="">Color</label>
                <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="color" type="text"  placeholder="" value="{{$product->color}}">
            </div>
    
            <div class="inline-block mt-2 w-1/2 pr-1">
              <label class=" block text-sm text-gray-600" for="">Lenght</label>
              <input   class="w-full px-2 py-2 text-gray-700 " id="" name="lenght" type="number"   placeholder=""  value="{{$product->lenght}}">
          </div>
          <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
              <label class=" block text-sm text-gray-600" for="">Width</label>
              <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="width" type="number"  value="{{$product->width}}"  >
          </div>
    
              <div class="inline-block mt-2 w-1/2 pr-1">
                <label class=" block text-sm text-gray-600" for="">Price</label>
                <input   class="w-full px-2 py-2 text-gray-700 " id="" name="price" type="text"  value="{{$product->price}}" >
            </div>
