                                 ...
                                 <tr >
                                    @foreach ($products as $product)   
                                       ...
                                       <td class="px-2 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">                                      
                                        <a href="{{url('/Product/reastore',$product->id)}}" class="text-blue-400 hover:text-gray-100 ml-5   py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded2">
                                            Restore
                                        </a>
                                        <a href="javascript:void(0)" recordid="{{$product->id}}" class="ConfirmDelete text-red-400 hover:text-gray-100 ml-5   py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded2">
                                            Delete
                                        </a>
                                    </td>
