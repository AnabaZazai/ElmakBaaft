    ...
    <form class="p-10 mr-5 ml-5  bg-white rounded shadow-xl" method="Post" enctype="multipart/form-data"  >
      @csrf
        ...
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
            ...
            <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="color" type="text"  placeholder="" >
                @error('color')
                <div class="text-sm text-red-600">{{ $message }}</div>
                @enderror
        </div>
        ...
        <div class="inline-block mt-2 w-1/3 pr-1">
          ...
          <input   class="w-full px-2 py-2 text-gray-700 " id="" name="lenght" type="number"   placeholder="" >
            @error('lenght')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
      <div class="inline-block mt-2 -mx-1 pl-1 w-1/3">
          ...
          <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="width" type="number"  placeholder="" >
            @error('width')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
       ...
       <div class="inline-block mt-2 -mx-1 pl-1 w-1/3">
            ...
            <input   class="w-full px-2 py-2 m-2 text-gray-700 " id="" name="price" type="text"  placeholder="" >
                @error('price')
                <div class="text-sm text-red-600">{{ $message }}</div>
                @enderror
        </div>
