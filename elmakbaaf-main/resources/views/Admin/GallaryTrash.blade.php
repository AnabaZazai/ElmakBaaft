        ...
        @foreach ($gallary as $gallary)
            <div class="w-full rounded h-50">
                ...
                <br>
                  ...
                  <a  href="{{url('/websitegallary/reastore',$gallary->id)}}" class="  hover:text-gray-100 ml-5 text-blue-400  py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded">
                    Restore
                  </a>
