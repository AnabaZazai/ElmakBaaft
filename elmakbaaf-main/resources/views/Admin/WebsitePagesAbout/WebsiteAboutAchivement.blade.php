...
<div class="border-collapse w-full flex flex-col pt-4 bg-gray-100">
    ...
    <form class="p-10 ml-5 mr-5 bg-white rounded shadow-xl" method="Post" enctype="multipart/form-data" action="/websiteAboteAchivement" >
      ...
      <div class="inline-block mt-2 w-1/4 pr-1">
          ...
          <input   class="w-full px-2 py-2 text-gray-700 " id="" name="titale" type="text"  placeholder="" >
          @error('titale')
      ...
      <div class="inline-block mt-2 -mx-1 pl-1 w-1/4">
          ...
          <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="year" type="text"  placeholder="" >
          @error('year')
          <div class="text-sm text-red-600">{{ $message }}</div>
          @enderror
        </div>
      <div class="inline-block mt-2 w-1/4 pr-1">
          ...
          <input   class="w-full m-2 px-2 py-2 text-gray-700 " id="" name="achivement" type="text"  placeholder="" >
          @error('achivement')
          <div class="text-sm text-red-600">{{ $message }}</div>
          @enderror
      </div>
      <div class="inline-block mt-2 -mx-1 pl-1 w-1/4">
          ...
          <input   class="w-full m-2 px-2 py-2 text-gray-700 " id=""  name="description" type="text"  placeholder="" >
          @error('description')
          <div class="text-sm text-red-600">{{ $message }}</div>
          @enderror
        </div>
