        ...
        <form class="p-10 bg-white rounded shadow-xl" method="Post" enctype="multipart/form-data" >
          ...
          @method('PUT')
            ...
            <div class="inline-block mt-2 w-1/2 pr-1">
                ...
                <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="collication"  type="text"  placeholder="" value="{{$orderitem->collication}}" >
            </div>
            <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                <label class=" block text-sm text-gray-600" for="">Size</label>
                <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="size" type="text"  placeholder="" value="{{$orderitem->size}}">
            </div>
    
            <div class="inline-block mt-2 w-1/2 pr-1">
                <label class=" block text-sm text-gray-600" for="">Dsighn</label>
                <input   class="w-full px-2 py-2 text-gray-700 " id="" name="design" type="text"  placeholder="" value="{{$orderitem->design}}" >
            </div>
            <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                <label class=" block text-sm text-gray-600" for="">Color</label>
                <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="color" type="text"  placeholder="" value="{{$orderitem->color}}">
            </div>
    
            <div class="inline-block mt-2 w-1/2 pr-1">
              <label class=" block text-sm text-gray-600" for="">Lenght</label>
              <input   class="w-full px-2 py-2 text-gray-700 " id="" name="lenght" type="number"   placeholder=""  value="{{$orderitem->lenght}}">
          </div>
          <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
              <label class=" block text-sm text-gray-600" for="">Width</label>
              <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="width" type="number"  value="{{$orderitem->width}}"  >
          </div>
{{-- 
          <div class="inline-block mt-2 w-1/2 pr-1">
            <label class=" block text-sm text-gray-600" for="">Quantity</label>
            <input   class="w-full px-2 py-2 text-gray-700 " id="" name="quantity" type="text"   placeholder=""  value="{{$orderitem->quantity}}">
        </div> --}}
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
            <label class=" block text-sm text-gray-600" for="">Quality</label>
            <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="quality" type="text"  value="{{$orderitem->quality}}"  >
        </div>

              <div class="inline-block mt-2 -mx-1 pl-1 w-1/2 ml-1">
                <label class=" block text-sm text-gray-600" for="">Unit_area</label>
                <input   class="w-full px-2 py-2 text-gray-700 " id="" name="unit_area" type="text"  value="{{$orderitem->unit_area}}" >
            </div>
