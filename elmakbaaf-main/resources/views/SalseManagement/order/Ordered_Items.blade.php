    ...
    <form class="p-10 ml-5 mr-5 bg-white rounded shadow-xl" method="Post" enctype="multipart/form-data"  >
      @csrf
        ...
        <div class="inline-block mt-2 w-1/4 pr-1">
            ...
            <input   class="w-full px-2 py-2 text-gray-700 " id="" name="collication" type="text"  placeholder="" >
            @error('collication')
        ...
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/4">
            ...
            <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="size" type="text"  placeholder="" >
            @error('size')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        <div class="inline-block mt-2 w-1/4 pr-1">
            ...
            <input   class="w-full m-2 px-2 py-2 text-gray-700 " id="" name="unit_area" type="text"  placeholder="" >
            @error('unit_area')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/4">
            ...
            <input   class="w-full m-2 px-2 py-2 text-gray-700 " id=""  name="color" type="text"  placeholder="" >
            @error('color')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="inline-block mt-2 w-1/4 pr-1">
            ...
            <input   class="w-full px-2 py-2 text-gray-700 " id="" name="design" type="text"  placeholder="" >
            @error('design')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/4">
            ...
            <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="quality" type="text"  placeholder="" >
            @error('quality')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="inline-block mt-2 w-1/4 pr-1">
            ...
            <input   class="w-full m-2 px-2 py-2 text-gray-700 " id="" name="lenght" type="text"  placeholder="" >
            @error('lenght')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/4">
            ...
            <input   class="w-full m-2 px-2 py-2 text-gray-700 " id=""  name="width" type="text"  placeholder="" >
            @error('width')
            <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
          ...
          <input   class="w-full px-2 py-2 text-gray-700 " id=""  name="file" type="file"  placeholder="" >
          @error('file')
          <div class="text-sm text-red-600">{{ $message }}</div>
          @enderror
        </div>    
            ...
            <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 mt-6">
              ...
              <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                ...
                <div class=" quantity flex flex-row h-10  rounded-lg relative bg-transparent mt-1 px-1 py-1  mx-3">
                  ...
                  <input  class="quantitychange focus:outline-none text-center w-full bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700  outline-none" name="quantity"   placeholder="" value="1">
                  <input  id=""   type="hidden"  placeholder="" value="{{$orderitem->id}}" name="orderitem_id" > 
