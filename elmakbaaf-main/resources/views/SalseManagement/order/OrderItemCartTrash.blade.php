                            ...
                            <table   class="min-w-full"> 
                                <thead>                       
                                  <tr >
                                        ...
                                        <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider pl-24">Action</th>
                                 ...
                                 <tr >
                                  ...
                                  @foreach ($orderitem as $orderitem)  
                                       ...
                                       <td class="px-2 flex py-7 whitespace-no-wrap  text-blue-900 border-gray-500 text-sm border-b leading-5">                                      
                                        <a href="{{url('/OrderedItem/reastore',$orderitem->id)}}" class="text-blue-400  mt-8 hover:text-gray-100 ml-5   py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded2">
                                            Restore
                                        </a>
  
                                        <div href="javascript:void(0)"  recordid="{{$orderitem->id}}" class="ConfirmDelete  mt-8 text-red-400 hover:text-gray-100 ml-5   py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded2">
                                              Delete
                                        </div>
